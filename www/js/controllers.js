...
function GoalsListCtrl($scope) {
  $scope.goals = [
    {"name": "Improve Footwork", "level": "Medium"},
    {"name": "Improve Strength", "level": "Medium"},
    {"name": "Trip to Boux", "level": "Long"}
  ];
    $scope.back = function () {
        navSvc.back();
    };
...
function TrainingListCtrl($scope,navSvc,$rootScope) {
    $scope.slidePage = function (path,type) {
        navSvc.slidePage(path,type);
    };
    $scope.back = function () {
    ...
    $scope.recent = [
        {"name": "Leading", "level": "Easy", "duration": "2", "when": "24/07/2013"},
        {"name": "Bouldering", "level": "Medium", "duration": "3", "when": "22/07/2013"},
        {"name": "Bouldering", "level": "Hard", "duration": "1", "when": "20/07/2013"}
    ];
}

function TrainingCtrl($scope, $rootScope) {
    $scope.training = {"when" : "23/07/2013"}

    $scope.init = function () {
        $scope.training = {"when" : "24/07/2013"}
    };

    $scope.addTraining = function () {
        $rootScope.saveTraining();
    };
}
